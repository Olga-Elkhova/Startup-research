...
сюда писать, то что будет сворачиваться
...
plt.show()
```
![Доля_сотрудников_без_информации](https://github.com/Olga-Elkhova/Startup-research/blob/main/Доля_сотрудников_без_информации.png)
...
plt.show()
```
![Распределение_стоимости_стартапов](https://github.com/Olga-Elkhova/Startup-research/blob/main/Распределение_стоимости_стартапов.png)
